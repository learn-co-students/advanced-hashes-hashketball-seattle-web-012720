...
def most_points_scored
  ...
  game_hash.each do |place, team|
    team.each do |attribute, data|
      if attribute == :players
        data.each do |player|
          if player[:points] > most_hoops
            most_hoops = player[:points]
...
def winning_team
  ...
  game_hash.each do |place, team|
    if team[:team_name] == "Brooklyn Nets"
          team.each do |attribute, data|
            if attribute == :players
              data.each do |player|
                nets_team_points << player[:points]
              end
              game_hash.each do |place, team|
                if team[:team_name] == "Charlotte Hornets"
                  team.each do |attribute, data|
                    if attribute == :players
                      data.each do |player|
                        hornets_team_points << player[:points]
                      end
          end
        end
      end
 ...
 if hornets_team_points.sum < nets_team_points.sum
